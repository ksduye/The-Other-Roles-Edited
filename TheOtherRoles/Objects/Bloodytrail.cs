...
namespace TheOtherRolesEdited.Objects {
    class Bloodytrail {
        ...
        public static List<Sprite> getBloodySprites() {
            ...
            sprites.Add(Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.Blood1.png", 700));
            sprites.Add(Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.Blood2.png", 500));
            sprites.Add(Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.Blood3.png", 300));
            return sprites;
        }
