...
namespace TheOtherRolesEdited.Objects {
    class Garlic {
        ...
        public static Sprite getGarlicSprite() {
            ...
            garlicSprite = Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.Garlic.png", 300f);
            return garlicSprite;
        }
        ...
        public static Sprite getBackgroundSprite() {
            ...
            backgroundSprite = Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.GarlicBackground.png", 60f);
