...
namespace TheOtherRolesEdited {
    public class CustomOption {
        ...
        public static void deserializeOptions(byte[] inputValues) {
            ...
            while (reader.BaseStream.Position < inputValues.Length) {
                try {
                    ...
                    TheOtherRolesEditedPlugin.Logger.LogWarning($"{e}: while deserializing - tried to paste invalid settings!");
                }
            }
        }
        ...
        public static bool pasteFromClipboard() {
            ...
            try {
                ...
                TheOtherRolesEditedPlugin.Logger.LogWarning($"{e}: tried to paste invalid settings!");
    ...
    class GameOptionsMenuStartPatch {
        public static void Postfix(GameOptionsMenu __instance) {
            ...
            copyButtonRenderer.sprite = Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.CopyButton.png", 175f);
            ...
            pasteButtonRenderer.sprite = Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.PasteButton.png", 175f);
        ...
        private static void createClassicTabs(GameOptionsMenu __instance) {
            bool isReturn = setNames(
                new Dictionary<string, string>() {
                    ["TORSettings"] = "TheOtherRolesEdited设置",
            ...
            var torTabHighlight = getTabHighlight(torTab, "TheOtherRolesEditedTab", "TheOtherRolesEdited.Resources.TabIcon.png");

            var impostorTab = UnityEngine.Object.Instantiate(roleTab, torTab.transform);
            var impostorTabHighlight = getTabHighlight(impostorTab, "ImpostorTab", "TheOtherRolesEdited.Resources.TabIconImpostor.png");

            var neutralTab = UnityEngine.Object.Instantiate(roleTab, impostorTab.transform);
            var neutralTabHighlight = getTabHighlight(neutralTab, "NeutralTab", "TheOtherRolesEdited.Resources.TabIconNeutral.png");

            var crewmateTab = UnityEngine.Object.Instantiate(roleTab, neutralTab.transform);
            var crewmateTabHighlight = getTabHighlight(crewmateTab, "CrewmateTab", "TheOtherRolesEdited.Resources.TabIconCrewmate.png");

            var modifierTab = UnityEngine.Object.Instantiate(roleTab, crewmateTab.transform);
            var modifierTabHighlight = getTabHighlight(modifierTab, "ModifierTab", "TheOtherRolesEdited.Resources.TabIconModifier.png");
        ...
        private static void createGuesserTabs(GameOptionsMenu __instance) {
            ...
            var guesserTabHighlight = getTabHighlight(guesserTab, "GuesserTab", "TheOtherRolesEdited.Resources.TabIconGuesserSettings.png");
        ...
        private static void createHideNSeekTabs(GameOptionsMenu __instance) {
            ...
            var torTab = UnityEngine.Object.Instantiate(roleTab, gameTab.transform.parent);
            var torTabHighlight = getTabHighlight(torTab, "TheOtherRolesEditedTab", "TheOtherRolesEdited.Resources.TabIconHideNSeekSettings.png");

            var hideNSeekTab = UnityEngine.Object.Instantiate(roleTab, torTab.transform);
            var hideNSeekTabHighlight = getTabHighlight(hideNSeekTab, "HideNSeekTab", "TheOtherRolesEdited.Resources.TabIconHideNSeekRoles.png");
        ...
        private static void createPropHuntTabs(GameOptionsMenu __instance) {
            ...
            var torTab = UnityEngine.Object.Instantiate(roleTab, gameTab.transform.parent);
            var torTabHighlight = getTabHighlight(torTab, "TheOtherRolesEditedTab", "TheOtherRolesEdited.Resources.TabIconPropHuntSettings.png");
        ...
        private static void setOptions (List<GameOptionsMenu> menus, List<List<OptionBehaviour>> options, List<GameObject> settings) {
            if (!(menus.Count == options.Count && options.Count == settings.Count)) {
                TheOtherRolesEditedPlugin.Logger.LogError("List counts are not equal");
                return;
            }
    ...
    public static class GameOptionsNextPagePatch
    {
        public static void Postfix(KeyboardJoystick __instance)
        {
            ...
            if (page != TheOtherRolesEditedPlugin.optionsPage) {
    ...
    public class HudManagerUpdate {
        ...
        public static void Postfix(HudManager __instance) {
            if (!toggleSettingsButton || !toggleSettingsButtonObject) {
                ...
                renderer.sprite = Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.CurrentSettingsButton.png", 180f);
