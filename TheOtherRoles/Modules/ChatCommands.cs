        ...
        private static class SendChatPatch {
            static bool Prefix(ChatController __instance) {
                ...
                if (AmongUsClient.Instance.GameState != InnerNet.InnerNetClient.GameStates.Started) {
                    if (text.ToLower().StartsWith("/Ìß³ö")) {
                        ...
                        if (gm.StartsWith("±äÐÎ¶ãÃ¨Ã¨") || gm.StartsWith("¶ãÃ¨Ã¨")) {
                            gameMode = CustomGamemodes.PropHunt;
                        } else if (gm.StartsWith("¶Ä¹ÖÄ£Ê½") || gm.StartsWith("¶Ä¹Ö")) {
                            gameMode = CustomGamemodes.Guesser;
                        } else if (gm.StartsWith("×½ÃÔ²ØÄ£Ê½") || gm.StartsWith("×½ÃÔ²Ø")) {
