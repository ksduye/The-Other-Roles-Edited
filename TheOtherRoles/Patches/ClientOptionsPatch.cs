...
namespace TheOtherRolesEdited.Patches 
{
    ...
    public static class ClientOptionsPatch
    {
        private static readonly SelectionBehaviour[] AllOptions = {
            new("幽灵可以查看任务&其他", () => TORMapOptions.ghostsSeeInformation = TheOtherRolesEditedPlugin.GhostsSeeInformation.Value = !TheOtherRolesEditedPlugin.GhostsSeeInformation.Value, TheOtherRolesEditedPlugin.GhostsSeeInformation.Value),
            new("幽灵可以看到地图上的管道", () => TORMapOptions.ghostsSeeVotes = TheOtherRolesEditedPlugin.GhostsSeeVotes.Value = !TheOtherRolesEditedPlugin.GhostsSeeVotes.Value, TheOtherRolesEditedPlugin.GhostsSeeVotes.Value),
            new("幽灵可以看到职业", () => TORMapOptions.ghostsSeeRoles = TheOtherRolesEditedPlugin.GhostsSeeRoles.Value = !TheOtherRolesEditedPlugin.GhostsSeeRoles.Value, TheOtherRolesEditedPlugin.GhostsSeeRoles.Value),
            new("幽灵可以看到附加职业", () => TORMapOptions.ghostsSeeModifier = TheOtherRolesEditedPlugin.GhostsSeeModifier.Value = !TheOtherRolesEditedPlugin.GhostsSeeModifier.Value, TheOtherRolesEditedPlugin.GhostsSeeModifier.Value),
            new("显示角色摘要", () => TORMapOptions.showRoleSummary = TheOtherRolesEditedPlugin.ShowRoleSummary.Value = !TheOtherRolesEditedPlugin.ShowRoleSummary.Value, TheOtherRolesEditedPlugin.ShowRoleSummary.Value),
