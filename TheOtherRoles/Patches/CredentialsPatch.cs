...
namespace TheOtherRolesEdited.Patches
{
    ...
    public static class CredentialsPatch
    {
        public static string fullCredentialsVersion =
            $@"<size=130%><color=#ff351f>TheOtherRolesEdited</color></size> v{TheOtherRolesEditedPlugin.Version.ToString() + TheOtherRolesEditedPlugin.AfterVersionString + (TheOtherRolesEditedPlugin.betaDays > 0 ? "-BETA" : "")}";
...
<color=#FF0000>TORE</color>模组作者:<color=#FCCE03FF>毒液</color> & <color=#FCCE03FF>方块</color>
美术:<color=#FCCE03FF>毒液</color>
中文翻译:<color=#FCCE03FF>毒液</color> & <color=#FCCE03FF>方块</color></size>";
...
<color=#FF0000>TORE</color>模组作者:<color=#FCCE03FF>毒液</color> & <color=#FCCE03FF>方块</color>
美术:<color=#FCCE03FF>毒液</color>
中文翻译:<color=#FCCE03FF>毒液</color> & <color=#FCCE03FF>方块</color>";

        public static string contributorsCredentials =
            $@"<size=60%> <color=#FCCE03FF>特别感谢 Smeggy & Imp11</color></size>";
        ...
        public static class LogoPatch
        {
            ...
            static void Postfix(PingTracker __instance)
            {
                ...
                credentials.SetText(
                    $"v{TheOtherRolesEditedPlugin.Version.ToString() + (TheOtherRolesEditedPlugin.betaDays > 0 ? "-BETA" : "")}\n<size=30f%>\n</size>{mainMenuCredentials}\n<size=30%>\n</size>{contributorsCredentials}");
            ...
            public static void loadSprites()
            {
                if (bannerSprite == null)
                    bannerSprite = Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.Banner.png", 300f);
                if (banner2Sprite == null)
                    banner2Sprite = Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.Banner2.png", 300f);
                if (horseBannerSprite == null)
                    horseBannerSprite =
                        Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.bannerTheHorseRoles.png", 300f);
            }
