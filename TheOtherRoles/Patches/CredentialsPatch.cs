...
<color=#FF0000>TORE</color>模组作者： <color=#FCCE03FF>毒液</color>, <color=#FCCE03FF>方块er</color>
美术： <color=#FCCE03FF>毒液</color></size>";
...
$@"<size=60%> <color=#FCCE03FF>特别感谢 Smeggy & Imp11</color></size>";
        ...
        internal static class PingTrackerPatch
        {
            ...
            static void Postfix(PingTracker __instance)
            {
                ...
                if (AmongUsClient.Instance.GameState == InnerNet.InnerNetClient.GameStates.Started)
                {
                    ...
                    __instance.text.text = $"<size=130%><color=#ff351f>TheOtherRolesEdited</color></size> v{TheOtherRolesEditedPlugin.Version.ToString() + (TheOtherRolesEditedPlugin.betaDays > 0 ? "-BETA" : "")}\n{gameModeText}" + __instance.text.text;
        ...
        public static class MOTD
        {
            ...
            public static async Task loadMOTDs()
            {
                ...
                HttpResponseMessage response = await client.GetAsync("https://raw.githubusercontent.com/TheOtherRolesEditedAU/MOTD/main/motd.txt");
