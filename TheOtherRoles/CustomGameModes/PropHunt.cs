...
namespace TheOtherRolesEdited.CustomGameModes {
    ...
    class PropHunt {
        ...
        public static void updateWhitelistedObjects() {
            ...
            TheOtherRolesEditedPlugin.Logger.LogMessage($"after debug");
            whitelistedObjects = allNames.Split(Environment.NewLine, StringSplitOptions.RemoveEmptyEntries).ToList();
            TheOtherRolesEditedPlugin.Logger.LogMessage($"after split");
            
            TheOtherRolesEditedPlugin.Logger.LogMessage($"Last element: {whitelistedObjects.Last()}");
        }
